...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mudar a cor do player2 (inativo)
    ...
    private void doStuff(ImageView iv, int card){
        ...
        //coloca a imagem correda no imageview
        ...
        //checando qual imagem esta selecionada e savando ela temporatiamente
        if(cardNumber == 1){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    //checando se a imagem selecionada é igual
                    calculate();
                }
            }, 1000);
    ...
    private void calculate() {
        //se as imagens sao iguais remove e adiciona os pontos
        if (firstCard == secondCard) {
            ...
            //adiciona os pontos no jogador certo
            if(turn == 1){
                playerPoints++;
